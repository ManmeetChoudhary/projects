...
class LocationService {
  ...
  Stream<LocationData> periodicLocation() {
    ...
    Future<void> tick(_) async {
      ...
      if(currentLocation?.latitude !=_locationData?.latitude||currentLocation?.longitude !=_locationData?.longitude){
        print("is location same");
        print(currentLocation?.latitude !=_locationData?.latitude||currentLocation?.longitude !=_locationData?.longitude);
